...
we expect to reduce the total time for calculation by atleast 75%, and the remaining 25% would consist of --> (20% time for computational chemistry i.e. DFT modeling and the rest 5% for machine-learning)
...
n = 7 ### This corresponds to number of Li atoms
lim1 = 2
lim2 = (2 + (3*n))
lim3 = (3 + (3*n))
...
x_train, x_test, y_train, y_test = train_test_split(x, e, test_size = 0.10, random_state = 0)
# print (x_train)
...
print ("Score for Random Forest Regression:"), (model.score(x_test,y_test))
...
print ("Score for Linear Regression:"), (model.score(x_test,y_test))
#print (model.summary())
'''
...
'''
# print ("Score for Polynomial Regression:"), (model2.score(x_test,y_test))
